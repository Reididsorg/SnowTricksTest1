...
class EditTrickController extends BaseController
{
     ...
     */
    public function editTrick($slug, Request $request, FileUploader $fileUploader)
    {
            ...
            if ($formErrors) {
                ...
                foreach ($formErrors as $key => $fieldError) {
                    if ($fieldError === 'fileName') {
                        $form['images'][$key][$fieldError]->addError(new FormError(
                    ...
                    if ($fieldError === 'noChange') {
                        $form['images']->addError(new FormError(
